...
@Autonomous(name="AutoCompetitionBLUE", group="Competition")
//@Disabled
public class AutoCompetition extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        moveRobotTime(0,0,TURN_SPEED,0.44);
        moveRobotTime(0,STRAFE_SPEED,0,1.77);
