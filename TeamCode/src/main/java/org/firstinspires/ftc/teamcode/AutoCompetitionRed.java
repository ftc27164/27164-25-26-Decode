...
@Autonomous(name="AutoCompetitionRED", group="Competition")
//@Disabled
public class AutoCompetitionRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Autonomous sequence
        moveArm(0.5, LAUNCHER_SPEED_DOWN);
        sleep(500);
        moveArm(0.2, LAUNCHER_SPEED_UP);
        sleep(500);
        moveArm(0.5, LAUNCHER_SPEED_DOWN);
        moveRobotTime(DRIVE_SPEED_REVERSE, 0, 0, 0.2);
        moveIntake(0.35, 1.0);
        sleep(500);
        moveArm(0.2, 0.75);
        sleep(500);
        moveArm(0.5, LAUNCHER_SPEED_DOWN);
        moveRobotTime(DRIVE_SPEED_REVERSE, 0, 0, 0.65);
        moveRobotTime(0, 0, -TURN_SPEED, 0.5);
        moveRobotTime(0,-STRAFE_SPEED,0,0.63);
        ...
        moveRobotTime(DRIVE_SPEED_REVERSE, 0, 0, 0.65);
        moveArm(0.2,LAUNCHER_SPEED_DOWN);
        moveRobotTime(0,STRAFE_SPEED,0,0.7);;
        moveRobotTime(0, 0, TURN_SPEED, 0.75);
        moveRobotTime(DRIVE_SPEED, 0, 0, 2.5);
        sleep(500);
        moveArm(0.5, LAUNCHER_SPEED_UP);
        moveRobotTime(DRIVE_SPEED_REVERSE, 0, 0, 0.2);
        moveArm(0.2,LAUNCHER_SPEED_DOWN);
        moveRobotTime(DRIVE_SPEED_REVERSE, 0 ,0 , 0.7);
        moveRobotTime(0,0,-TURN_SPEED,0.55);
        moveRobotTime(0,-STRAFE_SPEED,0,1.65);
        ...
        moveRobotTime(DRIVE_SPEED_REVERSE, 0, 0, 0.65);
        moveRobotTime(0,STRAFE_SPEED,0,1.5);;
        moveRobotTime(0, 0, TURN_SPEED, 0.75);
        moveRobotTime(DRIVE_SPEED, 0, 0, 2.5);
        moveArm(0.2, LAUNCHER_SPEED_UP);
